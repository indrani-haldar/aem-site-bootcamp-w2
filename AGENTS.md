# AEM Site Bootcamp W2

This is an AEM as a Cloud Service project using the Java stack.

It is built locally using Maven and can be tested against a local Quickstart, and the Dispatcher configuration is validated locally using the Dispatcher Tools.
